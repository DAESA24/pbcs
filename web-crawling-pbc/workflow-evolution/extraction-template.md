...
```bash
ls -la "C:/Users/drewa/pbcs/web-crawling-pbc/workflows/[primary-workflow].md"
```

### 0.3 Create Extraction Output File

```bash
touch "C:/Users/drewa/pbcs/web-crawling-pbc/workflow-evolution/extractions/[output-filename].md"
```
