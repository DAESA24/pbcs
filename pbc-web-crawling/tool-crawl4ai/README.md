...
|------|----------|---------|
| crawl4ai (Python) | `C:\Users\drewa\pbcs\pbc-web-crawling\tool-crawl4ai\.venv\` | Python scripting with full API access |
...
C:\Users\drewa\pbcs\pbc-web-crawling\tool-crawl4ai\.venv\Scripts\python.exe ^
    C:\Users\drewa\pbcs\pbc-web-crawling\tool-crawl4ai\scripts\deep_crawl_docs.py ^
...
```bash
cd C:\Users\drewa\pbcs\pbc-web-crawling\tool-crawl4ai
uv venv
...
- Local docs: `c:\Users\drewa\work\dev\pbc-projects-dev\pbc-web-crawling-dev\crawl4ai-docs\`
