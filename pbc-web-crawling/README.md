...
|------|----------|---------|
| crawl4ai (Python) | `C:\Users\drewa\pbcs\pbc-web-crawling\.venv\` | Python scripting with full API access |
...
C:\Users\drewa\pbcs\pbc-web-crawling\.venv\Scripts\python.exe ^
    C:\Users\drewa\pbcs\pbc-web-crawling\scripts\deep_crawl_docs.py ^
...
```bash
cd C:\Users\drewa\pbcs\pbc-web-crawling
uv venv
