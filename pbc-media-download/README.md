...
/c/Users/drewa/pbcs/pbc-media-download/.venv/Scripts/python.exe \
    /c/Users/drewa/pbcs/pbc-media-download/scripts/download_youtube.py \
...
- **Peer capability:** pbc-web-crawling (both acquire content for RAG)
...
```bash
cd /c/Users/drewa/pbcs/pbc-media-download
uv venv
