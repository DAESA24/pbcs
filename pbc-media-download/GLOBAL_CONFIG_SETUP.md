...
- **Output Directory:** `/c/Users/drewa/pbcs/pbc-media-download/downloads/`
...
# Use config preset
yt-dlp --config-location /c/Users/drewa/pbcs/pbc-media-download/configs/audio-only.conf https://youtube.com/watch?v=VIDEO_ID
```
