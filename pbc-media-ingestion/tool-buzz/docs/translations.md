...
- **Source:** https://chidiwilliams.github.io/buzz/docs/usage/translations
- **Status:** 200
- **Validation:** PASS

---

[Skip to main content](https://chidiwilliams.github.io/buzz/docs/usage/translations#__docusaurus_skipToContent_fallback)
...
To use translation feature you will need to configure OpenAI API key and translation settings. Set OpenAI API ket in Preferences. Buzz also supports custom locally running translation AIs that support OpenAI API. For more information on locally running AIs see 
