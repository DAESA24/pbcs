...
- **Source:** https://chidiwilliams.github.io/buzz/docs/faq
- **Status:** 200
- **Validation:** PASS

---

[Skip to main content](https://chidiwilliams.github.io/buzz/docs/faq#__docusaurus_skipToContent_fallback)
On this page
### 1. Where are the models stored?[​](https://chidiwilliams.github.io/buzz/docs/faq#1-where-are-the-models-stored "Direct link to 1. Where are the models stored?")
...
### 2. What can I try if the transcription runs too slowly?[​](https://chidiwilliams.github.io/buzz/docs/faq#2-what-can-i-try-if-the-transcription-runs-too-slowly "Direct link to 2. What can I try if the transcription runs too slowly?")
...
### 3. How to record system audio?[​](https://chidiwilliams.github.io/buzz/docs/faq#3-how-to-record-system-audio "Direct link to 3. How to record system audio?")
...
### 4. What model should I use?[​](https://chidiwilliams.github.io/buzz/docs/faq#4-what-model-should-i-use "Direct link to 4. What model should I use?")
...
In addition to choosing an appropriate model size you also can choose whisper type.
  ...
  * **HuggingFace** option is a `Transformers` implementation and is good in that it supports wide range of custom models that may be optimized for a particular language. This option also supports 


### 5. How to get GPU acceleration for faster transcription?[​](https://chidiwilliams.github.io/buzz/docs/faq#5-how-to-get-gpu-acceleration-for-faster-transcription "Direct link to 5. How to get GPU acceleration for faster transcription?")
On Linux GPU acceleration is supported out of the box on Nvidia GPUs. If you still get any issues install 
On Windows GPU support is included in the installation `.exe`. CUDA 12 required, computers with older CUDA versions will use CPU. See 
### 6. How to fix `Unanticipated host error[PaErrorCode-9999]`?[​](https://chidiwilliams.github.io/buzz/docs/faq#6-how-to-fix-unanticipated-host-errorpaerrorcode-9999 "Direct link to 6-how-to-fix-unanticipated-host-errorpaerrorcode-9999")
...
### 7. Can I use Buzz on a computer without internet?[​](https://chidiwilliams.github.io/buzz/docs/faq#7-can-i-use-buzz-on-a-computer-without-internet "Direct link to 7. Can I use Buzz on a computer without internet?")
...
### 8. Buzz crashes, what to do?[​](https://chidiwilliams.github.io/buzz/docs/faq#8-buzz-crashes-what-to-do "Direct link to 8. Buzz crashes, what to do?")
...
If that does not help, check the log file for errors and `1.3.4`, to get to the logs folder go to `Help -> About Buzz` and click on `Show logs` button.
### 9. Where can I get latest development version?[​](https://chidiwilliams.github.io/buzz/docs/faq#9-where-can-i-get-latest-development-version "Direct link to 9. Where can I get latest development version?")
Latest development version will have latest bug fixes and most recent features. If you feel a bit adventurous it is recommended to try the latest development version as they needs some testing before they get released to everybody.
  ...
  * **For other** platforms do the following:
    ...
    4. Download the installation file. Please note that you need to be logged in the Github to see the download links. ![Latest build example](https://chidiwilliams.github.io/buzz/img/latest-development-build.jpeg)


### 10. Why is my system theme not applied to Buzz installed from Flatpak?[​](https://chidiwilliams.github.io/buzz/docs/faq#10-why-is-my-system-theme-not-applied-to-buzz-installed-from-flatpak "Direct link to 10. Why is my system theme not applied to Buzz installed from Flatpak?")
...
On Fedora run the following to install the necessary packages `sudo dnf install gnome-themes-extra qadwaitadecorations-qt{5,6} qt{5,6}-qtwayland`
  * [1. Where are the models stored?](https://chidiwilliams.github.io/buzz/docs/faq#1-where-are-the-models-stored)
  * [2. What can I try if the transcription runs too slowly?](https://chidiwilliams.github.io/buzz/docs/faq#2-what-can-i-try-if-the-transcription-runs-too-slowly)
  * [3. How to record system audio?](https://chidiwilliams.github.io/buzz/docs/faq#3-how-to-record-system-audio)
  * [4. What model should I use?](https://chidiwilliams.github.io/buzz/docs/faq#4-what-model-should-i-use)
  * [5. How to get GPU acceleration for faster transcription?](https://chidiwilliams.github.io/buzz/docs/faq#5-how-to-get-gpu-acceleration-for-faster-transcription)
  * [6. How to fix `Unanticipated host error[PaErrorCode-9999]`?](https://chidiwilliams.github.io/buzz/docs/faq#6-how-to-fix-unanticipated-host-errorpaerrorcode-9999)
  * [7. Can I use Buzz on a computer without internet?](https://chidiwilliams.github.io/buzz/docs/faq#7-can-i-use-buzz-on-a-computer-without-internet)
  * [8. Buzz crashes, what to do?](https://chidiwilliams.github.io/buzz/docs/faq#8-buzz-crashes-what-to-do)
  * [9. Where can I get latest development version?](https://chidiwilliams.github.io/buzz/docs/faq#9-where-can-i-get-latest-development-version)
  * [10. Why is my system theme not applied to Buzz installed from Flatpak?](https://chidiwilliams.github.io/buzz/docs/faq#10-why-is-my-system-theme-not-applied-to-buzz-installed-from-flatpak)
