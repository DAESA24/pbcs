...
- **Source:** https://chidiwilliams.github.io/buzz/docs/cli
- **Status:** 200
- **Validation:** PASS

---

[Skip to main content](https://chidiwilliams.github.io/buzz/docs/cli#__docusaurus_skipToContent_fallback)
On this page
## Commands[​](https://chidiwilliams.github.io/buzz/docs/cli#commands "Direct link to Commands")
###  `add`[​](https://chidiwilliams.github.io/buzz/docs/cli#add "Direct link to add")
...
```
  ...
  * [Commands](https://chidiwilliams.github.io/buzz/docs/cli#commands)
    * [`add`](https://chidiwilliams.github.io/buzz/docs/cli#add)
