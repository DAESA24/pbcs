...
- **Source:** https://chidiwilliams.github.io/buzz/docs/usage/file_import
- **Status:** 200
- **Validation:** PASS

---

[Skip to main content](https://chidiwilliams.github.io/buzz/docs/usage/file_import#__docusaurus_skipToContent_fallback)
**To import a file:**
...
**Available options:**
To reduce misspellings you can pass some commonly misspelled words in an `Initial prompt` that is available under `Advanced...` button. See this 
