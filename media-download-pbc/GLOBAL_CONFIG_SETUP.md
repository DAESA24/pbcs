...
A global yt-dlp configuration has been installed to make the media-download-pbc the default download location for all yt-dlp commands run globally.
...
- **Output Directory:** `/c/Users/drewa/pbcs/media-download-pbc/downloads/`
...
# Use config preset
yt-dlp --config-location /c/Users/drewa/pbcs/media-download-pbc/configs/audio-only.conf https://youtube.com/watch?v=VIDEO_ID
```
